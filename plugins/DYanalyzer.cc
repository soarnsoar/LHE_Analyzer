// -*- C++ -*-
//
// Package:    Analyzer/DYanalyzer
// Class:      DYanalyzer
// 
/**\class DYanalyzer DYanalyzer.cc Analyzer/DYanalyzer/plugins/DYanalyzer.cc
...
class DYanalyzer : public edm::one::EDAnalyzer<edm::one::SharedResources>  {
   public:
      explicit DYanalyzer(const edm::ParameterSet&);
      ~DYanalyzer();
...
//
DYanalyzer::DYanalyzer(const edm::ParameterSet& iConfig)
...
void
DYanalyzer::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  ////////////initialize/////////////
...
void
DYanalyzer::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
